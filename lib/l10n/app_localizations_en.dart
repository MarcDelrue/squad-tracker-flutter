...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get confirmLeaveSquadBody => 'Are you sure you want to leave the squad?';
  ...
  @override
  String get bluetoothPermanentlyDenied => 'Bluetooth permissions permanently denied';

  @override
  String get failedToUpdateStatus => 'Failed to update status. Please try again.';
  ...
  @override
  String get inviteToSquadBody => 'Share this code with users to join the squad:';
  ...
  @override
  String get helpAcceptedTitle => 'Help accepted';
  ...
  String helpAcceptedMany(String names, int count) {
    return '$names and $count others are on the way';
  }

  @override
  String helpAcceptedManyCapped(String names, int extra) {
    return '$names and +$extra others are on the way';
  }

  @override
  String helpAcceptedManyNoExtra(String names) {
    return '$names are on the way';
  }
}
