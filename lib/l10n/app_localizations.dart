...
abstract class AppLocalizations {
  ...
  /// No description provided for @helpAcceptedTitle.
  ///
  /// In en, this message translates to:
  /// **'Help accepted'**
  String get helpAcceptedTitle;

  /// No description provided for @helpAcceptedSingle.
  ///
  /// In en, this message translates to:
  /// **'{name} is on the way'**
  String helpAcceptedSingle(String name);

  /// No description provided for @helpAcceptedMany.
  ///
  /// In en, this message translates to:
  /// **'{names} and {count} others are on the way'**
  String helpAcceptedMany(String names, int count);

  /// No description provided for @helpAcceptedManyCapped.
  ///
  /// In en, this message translates to:
  /// **'{names} and +{extra} others are on the way'**
  String helpAcceptedManyCapped(String names, int extra);

  /// No description provided for @helpAcceptedManyNoExtra.
  ///
  /// In en, this message translates to:
